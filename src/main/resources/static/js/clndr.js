(function(factory){if(typeof define==='function'&&define.amd){define(['jquery','static/js/moment'],factory);}
else if(typeof exports==='object'){factory(require('jquery'),require('static/js/moment'));}
